...
--tab -e 'bash -c "sleep 8; roslaunch prometheus_gazebo sitl_ego_px4_uav2.launch; exec bash"' \
--tab -e 'bash -c "sleep 10; roslaunch prometheus_gazebo sitl_ego_planner_uav1.launch; exec bash"' \
--tab -e 'bash -c "sleep 13; roslaunch prometheus_gazebo sitl_ego_planner_uav2.launch; exec bash"' \
